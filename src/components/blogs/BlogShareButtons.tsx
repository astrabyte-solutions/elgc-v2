...
export function BlogShareButtons({ title }: { title: string }) {
  ...
  const items = [
    ...
    },
    {
      ...
      className: "hover:bg-[#0f2744] hover:text-white hover:border-[#0f2744]",
    },
    {
      label: "WhatsApp",
      icon: WhatsAppIcon,
    ...
    },
    {
      ...
      className: "hover:bg-[#22c55e] hover:text-white hover:border-[#22c55e]",
    },
  ];

  return (
    <div className="blog-sidebar-card">
      <h3 className="blog-sidebar-title">Share This Post</h3>
      <div className="flex flex-wrap gap-2">
        {items.map((item) => {
          ...
          return (
            <button
              ...
              className={`flex h-10 w-10 items-center justify-center rounded-lg border border-[#e8ecf0] bg-white text-[#64748b] transition-colors ${item.className}`}
        ...
        <button
          type="button"
          onClick={copyLink}
          className="flex h-10 w-10 items-center justify-center rounded-lg border border-[#e8ecf0] bg-white text-[#64748b] transition-colors hover:bg-[#f0fdf4] hover:text-[#16a34a] hover:border-[#22c55e]"
          title="Copy link"
